...
```{r}
#| label: table-2
#| tbl-cap: "Table 2. Implementation plan for 2026-27 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Atlantic Salmon in the Cheticamp watershed. Steps to incorporate field data, update models, and revise this WCRP are also included."
#| echo: false
#| results: asis
#| warning: false
